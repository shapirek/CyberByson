...
TABULA = os.environ.get('TABULA')
TABULA_kids = os.environ.get('TABULA_kids')
SCHEDULE_SHEET_URL = os.environ.get('SCHEDULE_SHEET_URL')
CHANNEL_ID = os.environ.get('CHANNEL_ID')
CHANNEL_LINK_PART = os.environ.get('CHANNEL_LINK_PART')
